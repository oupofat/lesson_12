...
for screenwriter in doctor_who:
    if screenwriter.writer not in writer:
        writer[screenwriter.writer]=[]
    writer[screenwriter.writer].append(screenwriter)
print("This is the writer who wrote these episodes.")
for author in writer["Steven Moffat"]:
    print(author.episode)