...
#4. How many episodes are there in the top 10 for each writer?
number_of_shows = {}
...
for writer,number_episodes in number_of_shows.items:
    print(writer, "had",number_episodes,"shows in the list of top 10")
    
for entry in number_of_shows.items():
    print(entry[0],"had"entry[1],"shows in the top 10.")